...
ARXIV_OVERRIDES: dict[str, list[str]] = {
    ...
    "2011.05995": ["axions", "dark-sector", "beamdump", "long-lived-particles"],
    "2207.08448": ["axions", "dark-sector", "beamdump", "long-lived-particles"],
    "2210.02462": ["dark-sector", "axions", "long-lived-particles"],
    "2308.08589": ["dark-sector", "axions", "long-lived-particles"],
    ...
    "1010.4309": ["bsm", "lhc"],
    "2407.14587": ["standard-model", "bsm", "amplitudes"],
}
